                ...
                child: Padding(
                  ...
                  child: Scrollbar(
                    ...
                    child: ListView.builder(
                        itemExtent: 200,
                        itemCount: ctrl.searchCtrl.text.isEmpty
                            ? ctrl.proccessTasks.length
                            : ctrl.completeSearchResults.length,
                        itemBuilder: (context, i) {
                          final task = ctrl.searchCtrl.text.isEmpty
                              ? ctrl.proccessTasks[i]
                              : ctrl.completeSearchResults[i];
                          return InkWell(
                              onTap: () {
                                Get.to(
                                    () => CompleteTaskDetailPage(task: task));
                              },
